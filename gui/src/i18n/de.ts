...
export const de: Record<TKey, string> = {
  ...
  "usage.range.thisMonth": "Diesen Monat",
  "usage.range.lastMonth": "Letzten Monat",
  ...
  "usage.filter.modelAll": "Alle Modelle",
  ...
  "usage.section.requests": "Anfragen",
  "usage.requests.col.model": "Modell",
  "usage.requests.loadError": "Anfrageverlauf konnte nicht geladen werden.",
