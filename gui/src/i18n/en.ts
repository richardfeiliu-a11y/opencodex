...
export const en = {
  ...
  "usage.section.requests": "Requests",
  "usage.requests.col.model": "Model",
  "usage.requests.loadError": "Could not load request history.",
