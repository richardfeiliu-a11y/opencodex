...
export const ko: Record<TKey, string> = {
  ...
  "usage.section.requests": "요청",
  "usage.requests.col.model": "모델",
  "usage.requests.loadError": "요청 기록을 불러오지 못했습니다.",
  "logs.loadMore": "더 불러오기",
