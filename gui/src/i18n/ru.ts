...
export const ru: Record<TKey, string> = {
  ...
  "usage.range.thisMonth": "Этот месяц",
  "usage.range.lastMonth": "Прошлый месяц",
  "usage.range.custom": "Произвольный",
  "usage.filter.provider": "Провайдер",
  "usage.filter.providerAll": "Все провайдеры",
  "usage.filter.model": "Модель",
  "usage.filter.modelAll": "Все модели",
  ...
  "usage.section.requests": "Запросы",
  "usage.requests.col.model": "Модель",
  "usage.requests.loadError": "Не удалось загрузить историю запросов.",
