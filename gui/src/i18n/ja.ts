...
export const ja: Record<TKey, string> = {
  ...
  "usage.section.requests": "リクエスト",
  "usage.requests.col.model": "モデル",
  "usage.requests.loadError": "リクエスト履歴を読み込めませんでした。",
  "logs.loadMore": "さらに読み込む",
